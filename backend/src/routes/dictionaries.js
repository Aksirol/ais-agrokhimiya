...
// ==================== ХІМІКАТИ ====================
router.get('/chemicals', authorizeRoles('admin', 'agronomist', 'operator'), async (req, res) => {
    try {
...
// ==================== СКЛАДИ ====================
router.get('/warehouses', authorizeRoles('admin', 'agronomist', 'operator'), async (req, res) => {
    try {
...
// ==================== ПОСТАЧАЛЬНИКИ ====================
router.get('/suppliers', authorizeRoles('admin', 'agronomist', 'operator'), async (req, res) => {
    try {
